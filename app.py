...
def index():
    if request.method == 'POST':
        try:
            DRIVER_PATH = r"C:\Users\hp\review-scrapper-aws-main\chromedriver.exe"
            ...
            client = pymongo.MongoClient("mongodb+srv://mayank8186:mayank8186@cluster0.mgvytba.mongodb.net/?retryWrites=true&w=majority")
            db = client['flipkart_scrap1']
            review_col = db['review_scrap_data']  #review_collection
